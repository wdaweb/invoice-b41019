   ...
   <tbody>
    <tr> 
     ...
     <td headers="months" class="title">
        ...
        <input type="number" class="form-control"　name="year" min="<?=date("Y")-1;?>" max="<?=date("Y")+1;?>" step="1" value="<?=date("Y");?>">
        <p class="adaw-f">年</p> 
    ...
    <tr> 
     ...
     <div class="input-group adaw">
       <input type="number" class="form-control" name="special_prize" min="00000001" max="99999999"> 
      </div>
    </td> 
    </tr> 
    <tr> 
    ...
    <tr> 
     ...
     <div class="input-group adaw">
       <input type="number" class="form-control" name="grand_prize" min="00000001" max="99999999"> 
      </div> 
      </td> 
     <!-- <td headers="grandPrize" class="number"> 
    ...
    <tr> 
     ...
     <div class="input-group">
        <input type="number" class="form-control" name="first_prize[]" min="00000001" max="99999999"> 
        <p class="adaw-s"></p> 
        <input type="number" class="form-control" name="first_prize[]" min="00000001" max="99999999"> 
        <p class="adaw-s"></p> 
        <input type="number" class="form-control" name="first_prize[]" min="00000001" max="99999999"> 
    ...
    <tr> 
     ...
     <div class="input-group">
        <input type="number" class="form-control" name="add_six_prize[]" min="001" max="999"> 
        <p class="adaw-s"></p> 
        <input type="number" class="form-control" name="add_six_prize[]" min="001" max="999"> 
        <p class="adaw-s"></p> 
        <input type="number" class="form-control" name="add_six_prize[]" min="001" max="999"> 
